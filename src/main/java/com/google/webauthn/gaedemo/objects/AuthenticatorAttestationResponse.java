...
public class AuthenticatorAttestationResponse extends AuthenticatorResponse {
  ...
  private static final Logger Log = Logger.getLogger(AuthenticatorAttestationResponse.class.getName());
  ...
  private void process(Gson gson, AttestationResponseJson parsedObject) throws ResponseException {
